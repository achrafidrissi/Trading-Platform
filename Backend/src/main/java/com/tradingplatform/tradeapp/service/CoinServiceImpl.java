...
import com.tradingplatform.tradeapp.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService {
    ...
    public List<Coin> getCoinList(int page) throws Exception {
        //chaque page contiendra 10 éléments, et +page Spécifie le numéro de la page à récupérer
        String url = "https://api.coingecko.com/api/v3/coins/markets" +
                "?vs_currency=usd&per_page=10&page=" + page;
    ...
    public String getTop50CoinsByMarketCapRank() throws Exception {
        String url = "https://api.coingecko.com/api/v3/coins/markets"+
                "?vs_currency=usd&perpage=50&page=1";
